# oidc settings for temporary on-demand credentials from AWS without needing to store long-lived access keys
...
# assume_role_policy used as a trust policy for AWS IAM policies
